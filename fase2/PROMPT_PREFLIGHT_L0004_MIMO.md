...
Realiza exclusivamente el preflight determinista de todos los documentos del manifiesto `corpus/lotes/L0004.json`. No hagas enriquecimiento, no leas analíticamente los textos, no construyas JSON analíticos, no ejecutes `ledger.py` y no escribas en `corpus/resultados/`.
