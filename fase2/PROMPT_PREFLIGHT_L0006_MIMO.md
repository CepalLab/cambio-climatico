...
`corpus/lotes/L0006.json`. No hagas enriquecimiento, no leas analíticamente los textos, no construyas
...
El manifiesto reservado es `corpus/lotes/L0006.json` y contiene 15 documentos. La misión termina al completar
