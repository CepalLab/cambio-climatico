...
La fuente canónica de Fase 3 es `corpus/resultados/`. El inventario documental base permanece en
`../documentos_definitivos_trazabilidad.csv`. Los lotes con certificación de promoción conservan además
su gemelo `doc_*.validation.json`; los resultados históricos anteriores a esa compuerta no deben
considerarse inválidos por carecer de ese archivo.
...
1. **Inventario y congelamiento.** Construir un manifiesto de los 244 JSON, verificar handles únicos y
