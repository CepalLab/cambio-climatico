# Tipología de documentos v0 — transformación primaria/secundaria

**Fecha**: 2026-07-07
**Estado**: v0, con 3 anclas de calibración (piloto doc09/doc13/doc11). Pendiente de discusión con el equipo del curso, igual que [codebook_v0.md](codebook_v0.md).
...
A diferencia de Desafío CEPAL, que ya tenía cientos de casos clasificados como ancla, este corpus arranca de cero. Los tres documentos del piloto son las primeras anclas — incluyendo el caso ambiguo, documentado como tal en vez de resuelto artificialmente:
...
| 13  | *Comercio, cambio climático y el impuesto fronterizo al carbono*                                    | #6 Sostenibilidad ambiental (tentativa) | #9 Integración económica (tentativa) | **Ambiguo sin resolver** — el documento vive genuinamente en la intersección de ambas; podría defenderse #9 como primaria con igual fuerza. Queda pendiente de criterio experto del equipo del curso, no forzado a una respuesta confiada                   |
...
Cada nueva anécdota que aparezca al calibrar los 11 documentos restantes de la muestra debería sumarse a esta tabla — es la "memoria institucional" del corpus climático, igual que `07_Guia_Estrategica_y_Escalabilidad.md` lo es para el corpus completo de 495.

## 4. Tipo de documento (formato/género — metadato, no parte de la tipología transformacional)

Se registra junto a la tipología porque el Paso 5 del protocolo depende de reconocer la serie: Policy Brief / Documento de proyecto o estudio técnico / Informe insignia o Panorama / Nota técnica. Los informes insignia y Panoramas suelen tener categorías ancla predefinidas por su propia naturaleza (p.ej., un Panorama Social ancla en #2) — vale la pena mantener una lista de esas anclas conocidas a medida que aparezcan en el corpus climático, aunque todavía no se ha encontrado un caso así en el piloto.
